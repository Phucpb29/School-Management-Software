...
public class NguoiHocJFrame extends javax.swing.JFrame {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        if (checkMaNH() && checkGmail() && checkPhone()) {
            insert();
        }
            ...
            if (list != null) {
                for (NguoiHoc nh : list) {
                    Object[] row = {
                        ...
                        nh.getEmail(),
                        nh.getMaNV(),
                        DateHelper.toString(nh.getNgayDK(), "dd/MMM/yyyy"),
                        nh.getGioitinh()
                    };
                    model.addRow(row);
                }
    ...
    NguoiHoc getModel() {
        ...
        model.setNgaySinh(DateHelper.toDate(txtNgayS.getText(), "MM/dd/yyyy"));
        model.setSoDT(txtSoDT.getText());
        model.setEmail(txtEmail.getText());
        model.setMaNV(txtMaNV.getText());
        model.setNgayDK(DateHelper.toDate(txtNgayDK.getText(), "MM/dd/yyyy"));
    ...
    void setModel(NguoiHoc model) {
        ...
        txtNgayS.setText(DateHelper.toString(model.getNgaySinh(), "dd/MM/yyyy"));
        txtSoDT.setText(model.getSoDT());
        txtEmail.setText(model.getEmail());
        txtMaNV.setText(model.getMaNV());
        txtNgayDK.setText(DateHelper.toString(model.getNgayDK(), "dd/MM/yyyy"));
